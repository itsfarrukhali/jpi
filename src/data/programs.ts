...
const shortCourses: Program[] = [
  {
    id: "sc-machinist",
    name: "Workshop Machinist",
    shortName: "Workshop Machinist",
    duration: "2 Months",
    seats: 20,
    eligibility: "8th Class pass | Age: 14+ years",
    description:
      "Hands-on training in lathe, milling, drilling, grinding machines. Learn to operate workshop machinery professionally.",
    icon: "settings",
    tag: "SHORT",
    category: "short-courses",
    subjects: [
  ...
  },
  {
    ...
    duration: "2 Months",
    seats: 25,
    eligibility: "Matric pass | Basic electronics knowledge preferred",
    description:
      "Introduction to PLC, SCADA, HMI programming, sensors, and industrial control systems.",
    icon: "cpu",
    tag: "SHORT",
    category: "short-courses",
    subjects: [
  ...
  {
    id: "sc-office-automation",
    name: "Office Automation",
    shortName: "Office Automation",
    duration: "2 Months",
    seats: 30,
    eligibility: "Matric pass | Basic computer knowledge",
    description:
      "Master MS Office suite, email management, data entry, and office productivity tools for modern workplaces.",
    icon: "laptop",
    tag: "SHORT",
    category: "short-courses",
    subjects: [
  ...
  },
  {
    ...
    duration: "2 Months",
    seats: 25,
    eligibility: "Matric pass | Computer knowledge required",
    description:
      "Learn HTML, CSS, JavaScript, and build responsive websites. Perfect for freelancing and career start in tech.",
    icon: "code",
    tag: "SHORT",
    category: "short-courses",
    subjects: [
  ...
  {
    id: "sc-digital-marketing",
    name: "Digital Marketing",
    shortName: "Digital Marketing",
    duration: "2 Months",
    seats: 25,
    eligibility: "Matric pass | Social media familiarity preferred",
    description:
      "Master social media marketing, SEO, Google Ads, content creation, and freelancing strategies.",
    icon: "trending-up",
    tag: "SHORT",
    category: "short-courses",
    subjects: [
  ...
  {
    id: "sc-advanced-welding",
    name: "Advanced Welding",
    shortName: "Advanced Welding",
    duration: "2 Months",
    seats: 20,
    eligibility: "8th Class pass | Age: 14+ years",
    description:
      "Advanced MIG, TIG, and Arc welding techniques with industrial-grade training and certification.",
    icon: "flame",
    tag: "SHORT",
    category: "short-courses",
    subjects: [
  ...
  },
  {
    ...
    eligibility: "Matric pass | Basic computer knowledge",
    description:
      "Learn AutoCAD 2D drafting, 3D modeling, architectural and mechanical drawing for professional design careers.",
    icon: "pencil-ruler",
    tag: "SHORT",
    category: "short-courses",
    subjects: [
  ...
  {
    id: "sc-rac",
    name: "Refrigeration Repairing & Air Conditioning Installation Course",
    shortName: "RAC Repair & Installation",
    duration: "2 Months",
    seats: 20,
    eligibility: "8th Class pass | Basic mechanical knowledge preferred",
    description:
      "Complete training in refrigeration repair, AC installation, maintenance, and troubleshooting.",
    icon: "thermometer",
    tag: "SHORT",
    category: "short-courses",
    subjects: [
