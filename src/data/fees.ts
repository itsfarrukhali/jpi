...
export const jceFeeStructure: CategoryFeeStructure = {
  ...
  subtitle: "2-Month Hands-on Summer Camp & Industrial Skill Courses.",
  badge: "JCE / Short Courses",
  badgeColor: "bg-purple-700 text-white",
  headers: ["Course Name", "Duration", "Admission / Reg", "Course Fee", "Total Fee"],
  rows: [
    {
      label: "Workshop Machinist (Lathe, Milling, Workshop)",
      duration: "2 Months",
      admissionFee: "Rs. 2,000",
      tuitionFee: "Rs. 10,000",
      totalFee: "Rs. 12,000",
    },
    {
      label: "Industrial Automation (PLC, SCADA, Sensors)",
      duration: "2 Months",
      admissionFee: "Rs. 3,000",
      tuitionFee: "Rs. 12,000",
      totalFee: "Rs. 15,000",
    },
    {
